...
Public Class frmAgentSetting
            ...
            If openDialog1.ShowDialog() = DialogResult.OK Then
                ...
                Using connection As New MySqlConnection(My.Settings.conPathDb)
                    ...
                    Using command As New MySqlCommand(query, connection)
                        command.Parameters.AddWithValue("@Password", Mode.password)
                        command.Parameters.AddWithValue("@Username", Mode.username)
                        command.Parameters.AddWithValue("@Role", Mode.user_role)
    ...
    Private Sub frmAgentSetting_Load(sender As Object, e As EventArgs) Handles Me.Load
        txtUserRole.Text = Mode.user_role
        txtUsername.Text = Mode.username
    ...
    Private Sub btnChange_Click(sender As Object, e As EventArgs) Handles btnChange.Click
        ...
        Try
            ...
            If Not txtPass.Text.Equals(Mode.password) Then
