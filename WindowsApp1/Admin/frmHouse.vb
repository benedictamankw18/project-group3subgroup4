...
Public Class frmHouse
    ...
    Private Sub dgvHouseManagement_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvHouseManagement.CellClick
        If e.ColumnIndex >= 0 And e.RowIndex >= 0 Then
            Dim row As DataGridViewRow
            row = Me.dgvHouseManagement.Rows(e.RowIndex)
            ...
            If Not (row.Cells("First_image").Value Is DBNull.Value) Then
                ...
                Using ms As New MemoryStream(imageData)
                    pboPropertyImage1.Image = Image.FromStream(ms)
                End Using
            Else
            ...
            If Not (row.Cells("Second_image").Value Is DBNull.Value) Then
                ...
                Using ms As New MemoryStream(imageData)
                    pboPropertyImage2.Image = Image.FromStream(ms)
                End Using
            Else
            ...
            If Not (row.Cells("Third_image").Value Is DBNull.Value) Then
                ...
                Using ms As New MemoryStream(imageData)
                    pboPropertyImage3.Image = Image.FromStream(ms)
                End Using
            Else
            ...
            If Not (row.Cells("Fourth_image").Value Is DBNull.Value) Then
                ...
                Using ms As New MemoryStream(imageData)
                    pboPropertyImage4.Image = Image.FromStream(ms)
                End Using
            Else
